...
class PasajeroNecesidad extends Pasajero{
    ...
    public function darPorcentajeIncremento(){
        ...
        //1 y 2 necesidades
        }elseif(($this->getSillaRuedas() && $this->getAsistenciaEmbarque() && !$this->getAlimento()) || ($this->getSillaRuedas() && !$this->getAsistenciaEmbarque() && $this->getAlimento()) || (!$this->getSillaRuedas() && $this->getAsistenciaEmbarque() && $this->getAlimento()) || ($this->getSillaRuedas() && !$this->getAsistenciaEmbarque() && !$this->getAlimento()) || (!$this->getSillaRuedas() && $this->getAsistenciaEmbarque() && !$this->getAlimento()) || (!$this->getSillaRuedas() && !$this->getAsistenciaEmbarque() && $this->getAlimento())){
