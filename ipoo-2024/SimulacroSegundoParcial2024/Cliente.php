...
class Cliente{
    ...
    public function __toString(){
        $msjToString = "\n\nNombre del cliente TSC: ".$this->getNombre()."\nApellido  del cliente TSC: ".$this->getApellido()."\n¿Está dado de baja?  TSC ".$this->estadoCliente()."\nTipo de documento TSC: ".$this->getTipoDNI()."\nN° de documento TSC: ".$this->getNroDNI()."\n\n";
    ...
    /**
     * Lo que hace esta funcion es evaluar el estado y tipo de valor y nos devolvera un string
